...
from tts_impl.net.common.stft import STFT, ISTFT
...
class WaveHaxGenerator(nn.Module, GanVocoderGenerator):
    def __init__(self, in_channels: int = 100, internal_channels: int = 32, ffn_channels: int = 64, n_fft: int = 480, hop_length: int= 240, kernel_size: int = 7, num_harmonics: int = 8):
        super().__init__()
