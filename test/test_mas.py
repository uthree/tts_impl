...
from tts_impl.functional.monotonic_align import available_mas_algorithms, maximum_path


@pytest.mark.parametrize("batch_size", [1, 2])
@pytest.mark.parametrize("text_length", [100, 200])
@pytest.mark.parametrize("feat_length", [1000, 2000])
@pytest.mark.parametrize("algorithm", ["naive", "numba", "cython", "jit1", "jit2", "triton"])
