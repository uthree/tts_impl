...
class NsfHifigan(Recipe):
    ...
    def preprocess(self, target_dir:str = "your_target_dir", sample_rate: int = 22050, length:int = 8192):
    ...
    def prepare_datamodule(self, root_dir:str="dataset_cache", batch_size:int = 4) -> LightningDataModule:
        datamodule = AudioDataModule(root=root_dir, batch_size=batch_size, num_workers=1)
        return datamodule
